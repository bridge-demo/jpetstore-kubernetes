...
def deploy_petstore_monitoring( kubeconfigPath="./pipeline-python/tmp_kube_config.yaml" ) -> bool:
    LOGGER.info("Deploy monioring...")
    error = create_kubernetes_namespace(kubeconfigPath="./pipeline-python/tmp_kube_config.yaml", namespace="monitoring")
    if error:
