...
variable mysql_zone {
    type = string
    default = "1"
    description = "Availability zone for Azure MySQL Flexible Server. Keep this stable after creation."
}
...
variable kubernetes_version {
    ...
    default = null
    description = "Optional Kubernetes version for AKS. Set null to let Azure pick a region-supported version."
}